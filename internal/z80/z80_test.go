...
func TestCompileTestFiles(t *testing.T) {
	tab := []string{
		"./testdata/opcodes",
		"./testdata/operators",
		"./testdata/opcodes_undocumented",
		"./testdata/operators_undocumented",
	}
	for _, i := range tab {
		builder := BuildCompiler
		if strings.HasSuffix(i, "_undocumented") {
			builder = BuildCompilerUndocumented
		}
		a, b, mes := ttarch.CompileTestFile(builder(), i)
