...
var SyntaxMap = map[*Keyword]SyntaxFn{
	...
	Intern("embed-file"):                   SyntaxFn((*Compiler).sEmbedFile),
	...
	Intern("#.vec"):                        SyntaxFn((*Compiler).sVec),
	...
	Intern("#.field"):                      SyntaxFn((*Compiler).sField),
	...
	Intern("experimental/define-constant"): SyntaxFn((*Compiler).sDefineConstant),
...
var FunMap = map[*Keyword]SyntaxFn{
	Intern("flat-vec"):           SyntaxFn((*Compiler).fFlatVec),
	...
	Intern("opposite-condition"): SyntaxFn((*Compiler).fOppositeCondition),
	Intern("unuse?"):             SyntaxFn((*Compiler).fUnusep),
	Intern("use?"):               SyntaxFn((*Compiler).fUsep),
	Intern("loaded-as-main?"):    SyntaxFn((*Compiler).fLoadedAsMain),
